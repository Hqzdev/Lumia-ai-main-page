        ...
        >
          ...
          <defs>
            ...
            >
              ...
              <stop offset="0.2" stopColor="hsl(var(--background))" stopOpacity="0.9" />
              <stop offset="0.8" stopColor="hsl(var(--background))" stopOpacity="0.9" />
            ...
            >
              <stop offset="0.1294" stopColor="hsl(var(--primary))" stopOpacity="0.3" />
              <stop offset="0.2347" stopColor="hsl(var(--primary))" stopOpacity="0.2" />
      ...
      <div className="relative z-10 flex flex-col justify-start items-center gap-9 max-w-4xl mx-auto">
        <div className="flex flex-col justify-start items-center gap-4 text-center">
          ...
          <p className="text-muted-foreground text-sm md:text-base font-medium leading-[18.20px] md:leading-relaxed break-words max-w-2xl">
            Discover how developers accelerate their workflows, collaborate effortlessly, and create confidently using Lumia’s AI-powered tools.
          </p>
        </div>
