...
const testimonials = [
  {
    ...
    name: "Alex Peterson",
    role: "Web Developer",
    content: "Yumi.AI has significantly accelerated my workflow. Now I can generate code faster and more efficiently. The AI suggestions are always relevant and help me write better code.",
  ...
  },
  {
    ...
    name: "David Smith",
    role: "Entrepreneur",
    content: "Using Yumi.AI for market analysis and business idea generation. The results are impressive! It helps me make data-driven decisions and identify new opportunities.",
