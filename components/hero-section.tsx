    ...
    >
        ...
        >
          <g clipPath="url(#clip0_186_1134)">
            ...
            <g mask="url(#mask0_186_1134)">
              ...
              <rect x="699.711" y="81" width="36" height="36" fill="hsl(var(--foreground))" fillOpacity="0.15" />
              <rect x="195.711" y="153" width="36" height="36" fill="hsl(var(--foreground))" fillOpacity="0.15" />
              <rect x="1023.71" y="153" width="36" height="36" fill="hsl(var(--foreground))" fillOpacity="0.15" />
              <rect x="123.711" y="225" width="36" height="36" fill="hsl(var(--foreground))" fillOpacity="0.15" />
              <rect x="1095.71" y="225" width="36" height="36" fill="hsl(var(--foreground))" fillOpacity="0.15" />
              <rect x="951.711" y="297" width="36" height="36" fill="hsl(var(--foreground))" fillOpacity="0.15" />
              <rect x="231.711" y="333" width="36" height="36" fill="hsl(var(--foreground))" fillOpacity="0.15" />
              <rect x="303.711" y="405" width="36" height="36" fill="hsl(var(--foreground))" fillOpacity="0.15" />
              <rect x="87.7109" y="405" width="36" height="36" fill="hsl(var(--foreground))" fillOpacity="0.15" />
              <rect x="519.711" y="405" width="36" height="36" fill="hsl(var(--foreground))" fillOpacity="0.15" />
              <rect x="771.711" y="405" width="36" height="36" fill="hsl(var(--foreground))" fillOpacity="0.15" />
              <rect x="591.711" y="477" width="36" height="36" fill="hsl(var(--foreground))" fillOpacity="0.15" />
            </g>
          ...
          <defs>
            ...
            >
              <stop stopColor="hsl(var(--muted-foreground))" stopOpacity="0" />
              <stop offset="1" stopColor="hsl(var(--muted-foreground))" stopOpacity="0.3" />
            </linearGradient>
            <linearGradient
            ...
            >
              ...
              <stop offset="0.578125" stopColor="hsl(var(--primary))" stopOpacity="0.3" />
            ...
            >
              <stop stopColor="hsl(var(--muted-foreground))" stopOpacity="0.1" />
              <stop offset="0.157789" stopColor="hsl(var(--primary))" stopOpacity="0.3" />
      ...
      <Link href="https://auth.lumiaai.ru" target="_blank" rel="noopener noreferrer">
        <motion.div
          ...
          whileTap={{ scale: 0.95 }}
        >
          <Button className="relative z-10 bg-secondary text-secondary-foreground hover:bg-secondary/90 px-8 py-3 rounded-full font-medium text-base shadow-lg ring-1 ring-white/10 transition-all duration-200">
            Signup for free
          </Button>
        </motion.div>
      </Link>
